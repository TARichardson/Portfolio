  ...
  return (
    <div key="HomeDiv" className="MainContent">
      <div className="imgDiv">
        <img src="images/ID_Pro.jpg" alt="ID of Troy Aaron Richardson" />
      </div>
      <div className="projectDiv">
        <div className="pjDiv">
        <div className="TitleDiv"><h3>Checkers</h3></div>
          <a href="https://glistening-apples.surge.sh">
            <img src="images/P1.png" alt="ID of Troy Aaron Richardson" />
        ...
        <div className="pjDiv">
        <div className="TitleDiv"><h3>Gmail Cleaner</h3></div>
          <a href="https://scared-match.surge.sh">
            <img src="images/P2.png" alt="ID of Troy Aaron Richardson" />
        ...
        <div className="pjDiv">
        <div className="TitleDiv"><h3>Sneaker Critic</h3></div>
          <a href="http://pleasant-slip.surge.sh">

            <img src="images/P3.png" alt="ID of Troy Aaron Richardson" />
        ...
        <div className="pjDiv">
        <div className="TitleDiv"><h3>Men's watch site</h3></div>
          <a href="https://shrouded-ocean-71574.herokuapp.com">
            <img src="images/P4.png" alt="ID of Troy Aaron Richardson" />
